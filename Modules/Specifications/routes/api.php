...
use Modules\Specifications\Http\Controllers\SpecificationGroupController;
...
Route::middleware(['auth:sanctum'])->prefix('v1/admin')->group(function () {
    Route::apiResource('specifications-group', SpecificationGroupController::class)->names('specifications-group');
    
    Route::get('/specification-tree', [SpecificationsController::class, 'specificationTree']);       // لیست همه مشخصات
